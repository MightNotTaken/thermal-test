...
# Fixed Jetson Thermal Camera Sample Build Script
# This script fixes all compilation errors and builds successfully

set -e  # Exit on any error

echo "=== Fixed Jetson Thermal Camera Sample Build Script ==="
...
# Main build process
main() {
    echo "Starting fixed build process for Jetson Thermal Camera Sample..."
    echo ""
    ...
    print_success "=== Fixed Build Process Completed Successfully ==="
    echo ""
