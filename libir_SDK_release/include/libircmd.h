 ...
 * Support for WN2384T, GL21280T, TC2-C
 *
 * @param[in] handle ircmd's handle
 ...
 * Support for WN2/TIF series, GL21280 and WN2384T
 *
 * @param[in]  handle ircmd's handle
 *
 * @return see IrlibError_e
 ...
 * Support for WN2/TIF series and GL21280/GL21280T
 *
 * @param[in]  handle ircmd's handle
 *
 * @return see IrlibError_e
 ...
 * Support for WN2/GL21280/GL21280T
 *
 * @param[in] handle ircmd's handle
 ...
 * Support for WN2/TIF series, GL21280
 *
 * @param[in]  handle ircmd's handle
 ...
 * Support for WN2/TIF series, GL21280/GL21280T, TC2-C and WN2384T
 *
 * @param[in] handle ircmd's handle
 ...
 * Support for WN2/TIF series, WN2384T, GL21280T, TC2-C
 *
 * @param[in] handle ircmd's handle
 ...
 *          GL21280T MIPI,DVP, fill status, format and num
 ...
 * @support WN2384T, GL21280T and TC2-C
 *
 * @param[in]   handle ircmd's handle
 ...
 * @support WN2/TIF series and GL21280
 * @param[in]  handle ircmd's handle
 * @param[in]  status see basic_enable_status_e
 *
 * @return see IrlibError_e
...
/**
 * @brief Set the scale
 * Support for WN2/TIF series and GL21280
 *
 * @param[in]  handle ircmd's handle
 ...
 * Support for WN2384T, GL21280T and TC2-C
 *
 * @param[in] handle ircmd's handle
...
typedef enum {
    ...
    /// include dead pxiel data, recover data and tpd data, support for CS640, G1280S, WN2384T, GL21280T and TC2-C
    ...
    /// restore the system function parameter, support for WN2/TIF series, GL21280/GL21280T, WN2384T and P2L
    ...
    /// restore k value to default, support for WN2/TIF series, GL21280/GL21280T, WN2384T， TC2-C and P2L
    BASIC_RESTORE_K_VALUE = 3,
    /// restore dpc calib data to default, support for WN2/TIF series, GL21280/GL21280T, WN2384T， TC2-C and P2L
    BASIC_RESTROE_DPC_DATA = 4,
    /// restore rmcover calib data to default, support for WN2/TIF series, GL21280/GL21280T, WN2384T， TC2-C and P2L
    BASIC_RESTROE_RMCOVER_DATA = 5,
    /// restore one point tpd calib data to default, support for WN2384T, GL21280T, TC2-C and P2L
    BASIC_RESTORE_TPD_DATA = 6,
    /// restore profession scene level, support for TC2-C
    BASIC_RESTORE_PROFESSION_SCENE_LEVEL = 7,
    /// restore two points tpd calib data, support for WN2384T, GL21280T and TC2-C
...
typedef enum {
    ...
    /// save the changed system function parameter, support for WN2/TIF series, GL21280/GL21280T, WN2384T and P2L
    ...
    /// save k value after calib, support for WN2/TIF series, GL21280/GL21280T, WN2384T, TC2-C and P2L
    BASIC_SAVE_K_VALUE = 2,
    /// save dpc calib data after calib, support for WN2/TIF series, GL21280/GL21280T, WN2384T, TC2-C and P2L
    BASIC_SAVE_DPC_DATA = 3,
    /// save rmcover calib data after calib, support for WN2/TIF series, GL21280/GL21280T, WN2384T, TC2-C and P2L
    BASIC_SAVE_RMCOVER_DATA = 4,
    /// save one point tpd calib data after calib, support for WN2384T, GL21280T, TC2-C and P2L
    BASIC_SAVE_TPD_DATA = 5,
    /// save video output format, support for WN2/TIF series, GL21280/GL21280T, TC2-C and WN2384T
    BASIC_SAVE_VIDEO_OUTPUT_FORMAT = 6,
    /// save profession scene level, support for TC2-C
    BASIC_SAVE_PROFESSION_SCENE_LEVLE = 7,
    /// save two points tpd calib data after calib, support for WN2384T, GL21280T and TC2-C
